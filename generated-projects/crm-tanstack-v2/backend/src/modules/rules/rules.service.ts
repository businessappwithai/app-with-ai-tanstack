 ...
 *
 * Generated: 2026-05-15T16:06:25.837Z
 * Project: CRM App
 */
...
export class RulesService {
  ...
  async migrateFromFileSystem(): Promise<{ migrated: number; errors: string[] }> {
    ...
    const entityOperations = [
      { file: 'bus_account.jdm.json', entityName: 'bus_account', operation: 'CREATE' },
      { file: 'bus_contact.jdm.json', entityName: 'bus_contact', operation: 'CREATE' },
      { file: 'bus_opportunity.jdm.json', entityName: 'bus_opportunity', operation: 'CREATE' },
