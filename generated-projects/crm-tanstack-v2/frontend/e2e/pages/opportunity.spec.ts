...
test.describe('OPPORTUNITY CRUD Tests', () => {
  const entityName = 'OPPORTUNITY';
  const entityNamePlural = 'bus_opportunity';
  ...
  test('should update a OPPORTUNITY', async ({ page }) => {
  ...
  test('should delete a OPPORTUNITY', async ({ page }) => {
