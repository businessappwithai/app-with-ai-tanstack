 ...
 *
 * Generated: 2026-05-15T16:06:27.792Z
 * Project: CRM App
 */
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <SelectContent>
                ...
                {!sysTables.find((t) => t.table_name === 'bus_account') && (
                  <SelectItem value="bus_account">
                    ACCOUNT (bus_account)
                  </SelectItem>
                )}
                ...
                {!sysTables.find((t) => t.table_name === 'bus_opportunity') && (
                  <SelectItem value="bus_opportunity">
