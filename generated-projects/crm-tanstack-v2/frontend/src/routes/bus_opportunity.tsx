 ...
 *
 * Displays a paginated, sortable list of OPPORTUNITY records
 ...
 *
 * Generated: 2026-05-15T16:06:27.789Z
 * Project: CRM App
 */
...
export const Route = createFileRoute('/bus_opportunity')({
...
function EntityListPage() {
  ...
  const { data: gridFields } = useGridFields('bus_opportunity')
  ...
  const {
    ...
    queryKey: ['opportunity', 'list', page, pageSize, filterParams],
    queryFn: () => {
      ...
      return apiClient.get<PaginatedResponse<OPPORTUNITY>>(
        `/api/bus/bus_opportunity?${params.toString()}`,
      )
    },
  })
  ...
  const deleteMutation = useMutation({
    mutationFn: async (id: string) => {
      await apiClient.delete(`/api/bus/bus_opportunity/${id}`)
    },
    onSuccess: () => {
        ...
        <div className="container mx-auto py-8 px-4">
          <div className="flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-border/60 bg-muted/30 p-12 text-center">
            ...
            <p className="text-destructive text-lg font-semibold">
              Error loading OPPORTUNITY records
            </p>
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto py-8 px-4 space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">OPPORTUNITY entity</p>
                </div>
              </div>
            </div>
        ...
        <DynamicTable
          ...
          onView={(id) =>
            navigate({ to: '/bus_opportunity/$id', params: { id } })
          }
          onEdit={(id) =>
            navigate({ to: '/bus_opportunity/$id', params: { id } })
          }
