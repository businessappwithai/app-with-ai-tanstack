 ...
 * ACCOUNT List Page
 *
 * Displays a paginated, sortable list of ACCOUNT records
 ...
 *
 * Generated: 2026-05-15T16:06:27.787Z
 * Project: CRM App
 */
...
export const Route = createFileRoute('/bus_account')({
...
function EntityListPage() {
  ...
  const { data: gridFields } = useGridFields('bus_account')
  ...
  const {
    ...
    queryKey: ['account', 'list', page, pageSize, filterParams],
    queryFn: () => {
      ...
      return apiClient.get<PaginatedResponse<ACCOUNT>>(
        `/api/bus/bus_account?${params.toString()}`,
      )
    },
  })
  ...
  const deleteMutation = useMutation({
    mutationFn: async (id: string) => {
      await apiClient.delete(`/api/bus/bus_account/${id}`)
    },
    onSuccess: () => {
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto py-8 px-4 space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">ACCOUNT entity</p>
                </div>
              </div>
            </div>
        ...
        <DynamicTable
          ...
          onView={(id) => navigate({ to: '/bus_account/$id', params: { id } })}
          onEdit={(id) => navigate({ to: '/bus_account/$id', params: { id } })}
          onDelete={(id) => {
