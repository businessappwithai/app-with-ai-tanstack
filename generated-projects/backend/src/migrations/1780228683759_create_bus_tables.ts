 ...
 *
 * Generated: 2026-05-31T11:58:03.772Z
 */
...
export async function up(db: Kysely<any>): Promise<void> {
  ...
  await sql`
    ...
    ADD CONSTRAINT fk_bus_contact_company_id
      FOREIGN KEY (company_id)
      REFERENCES bus_company(id)
      ON DELETE SET NULL ON UPDATE CASCADE
  `.execute(db).catch(() => {});
  await sql`
    ALTER TABLE bus_deal
    ADD CONSTRAINT fk_bus_deal_company_id
      FOREIGN KEY (company_id)
      REFERENCES bus_company(id)
      ON DELETE SET NULL ON UPDATE CASCADE
  `.execute(db).catch(() => {});
  await sql`
    ...
    ADD CONSTRAINT fk_bus_activity_company_id
      FOREIGN KEY (company_id)
      REFERENCES bus_company(id)
      ON DELETE SET NULL ON UPDATE CASCADE
  `.execute(db).catch(() => {});
  await sql`
    ALTER TABLE bus_note
    ADD CONSTRAINT fk_bus_note_company_id
      FOREIGN KEY (company_id)
      REFERENCES bus_company(id)
      ON DELETE SET NULL ON UPDATE CASCADE
  `.execute(db).catch(() => {});
  await sql`
    ...
    ADD CONSTRAINT fk_bus_task_company_id
      FOREIGN KEY (company_id)
      REFERENCES bus_company(id)
      ON DELETE SET NULL ON UPDATE CASCADE
  `.execute(db).catch(() => {});
  await sql`
    ALTER TABLE bus_deal
    ADD CONSTRAINT fk_bus_deal_contact_id
  ...
  await sql`
    ALTER TABLE bus_note
    ADD CONSTRAINT fk_bus_note_contact_id
      FOREIGN KEY (contact_id)
      REFERENCES bus_contact(id)
      ON DELETE SET NULL ON UPDATE CASCADE
  `.execute(db).catch(() => {});
  await sql`
    ALTER TABLE bus_task
    ADD CONSTRAINT fk_bus_task_contact_id
      FOREIGN KEY (contact_id)
      REFERENCES bus_contact(id)
      ON DELETE SET NULL ON UPDATE CASCADE
  `.execute(db).catch(() => {});
  await sql`
    ALTER TABLE bus_email_message
    ADD CONSTRAINT fk_bus_email_message_contact_id
      FOREIGN KEY (contact_id)
      REFERENCES bus_contact(id)
      ON DELETE SET NULL ON UPDATE CASCADE
  `.execute(db).catch(() => {});
  await sql`
    ALTER TABLE bus_activity
    ADD CONSTRAINT fk_bus_activity_deal_id
      FOREIGN KEY (deal_id)
      REFERENCES bus_deal(id)
      ON DELETE SET NULL ON UPDATE CASCADE
  `.execute(db).catch(() => {});
  await sql`
    ALTER TABLE bus_note
    ADD CONSTRAINT fk_bus_note_deal_id
      FOREIGN KEY (deal_id)
      REFERENCES bus_deal(id)
      ON DELETE SET NULL ON UPDATE CASCADE
  `.execute(db).catch(() => {});
  await sql`
    ALTER TABLE bus_task
    ADD CONSTRAINT fk_bus_task_deal_id
      FOREIGN KEY (deal_id)
      REFERENCES bus_deal(id)
      ON DELETE SET NULL ON UPDATE CASCADE
  `.execute(db).catch(() => {});
  await sql`
    ...
    ADD CONSTRAINT fk_bus_quote_deal_id
      FOREIGN KEY (deal_id)
      REFERENCES bus_deal(id)
      ON DELETE SET NULL ON UPDATE CASCADE
  `.execute(db).catch(() => {});
  await sql`
    ALTER TABLE bus_email_message
    ADD CONSTRAINT fk_bus_email_message_deal_id
      FOREIGN KEY (deal_id)
      REFERENCES bus_deal(id)
      ON DELETE SET NULL ON UPDATE CASCADE
  `.execute(db).catch(() => {});
  await sql`
    ALTER TABLE bus_deal_stage
    ADD CONSTRAINT fk_bus_deal_stage_pipeline_id
      FOREIGN KEY (pipeline_id)
      REFERENCES bus_pipeline(id)
      ON DELETE SET NULL ON UPDATE CASCADE
  `.execute(db).catch(() => {});
  await sql`
    ALTER TABLE bus_quote_item
    ADD CONSTRAINT fk_bus_quote_item_quote_id
  ...
  await sql`
    ALTER TABLE bus_quote_item
    ADD CONSTRAINT fk_bus_quote_item_product_id
  ...
  await sql`
    ...
    ADD CONSTRAINT fk_bus_company_user_id
      FOREIGN KEY (user_id)
  ...
  await sql`
    ALTER TABLE bus_deal
    ADD CONSTRAINT fk_bus_deal_user_id
      FOREIGN KEY (user_id)
      REFERENCES bus_user(id)
      ON DELETE SET NULL ON UPDATE CASCADE
  `.execute(db).catch(() => {});
  ...
  await sql`
    ALTER TABLE bus_task
    ADD CONSTRAINT fk_bus_task_user_id
      FOREIGN KEY (user_id)
      REFERENCES bus_user(id)
      ON DELETE SET NULL ON UPDATE CASCADE
  `.execute(db).catch(() => {});
  await sql`
    ALTER TABLE bus_note
    ADD CONSTRAINT fk_bus_note_user_id
      FOREIGN KEY (user_id)
      REFERENCES bus_user(id)
      ON DELETE SET NULL ON UPDATE CASCADE
  `.execute(db).catch(() => {});
