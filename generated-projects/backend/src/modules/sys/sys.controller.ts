 ...
 *
 * Generated: 2026-05-31T11:58:03.754Z
 */
...
export class SysController {
  ...
  async findAllTables(
    ...
    return this.sysService.findAllTables({ page: page ? (parseInt(page, 10) || 1) : 1, limit: limit ? (parseInt(limit, 10) || 100) : 100, search, prefix });
  }
  ...
  async findAllColumns(
    ...
    return this.sysService.findAllColumns({ tableId, page: page ? (parseInt(page, 10) || 1) : 1, limit: limit ? (parseInt(limit, 10) || 100) : 100 });
  }
  ...
  async findAllFields(
    ...
    return this.sysService.findAllFields({ tabId, tableId, view, page: page ? (parseInt(page, 10) || 1) : 1, limit: limit ? (parseInt(limit, 10) || 100) : 100 });
  }
  ...
  async getFormFields(@Query('entity') entity: string) {
    return this.sysService.getFormFields(entity);
  }

  @Get('fields/grid')
  @ApiOperation({ summary: 'Get fields for grid display by table name' })
  async getGridFields(@Query('entity') entity: string) {
    return this.sysService.getGridFields(entity);
  }
  ...
  async createFieldGroup(@Body() data: Record<string, unknown>) {
  ...
  async findAllReferences(@Query('page') page?: string, @Query('limit') limit?: string) {
    return this.sysService.findAllReferences({ page: page ? (parseInt(page, 10) || 1) : 1, limit: limit ? (parseInt(limit, 10) || 100) : 100 });
  }
