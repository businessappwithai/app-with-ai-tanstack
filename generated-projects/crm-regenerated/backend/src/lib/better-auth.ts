 ...
 *
 * Modern authentication for CRM Regenerated
...
export async function initAuth() {
  if (!authInstance) {
    const dbDir = process.env.DATABASE_DIR || path.join(__dirname, '..', '..', 'data', 'crm_regenerated.db');
    ...
    authInstance = betterAuth({
      ...
      secret: process.env.BETTER_AUTH_SECRET || 'crm_regenerated-dev-secret',
      emailAndPassword: {
        enabled: true,
      ...
      advanced: {
        cookiePrefix: 'crm_regenerated_app',
