...
const dbPath = path.resolve(process.env.DATABASE_FILENAME || path.join(__dirname, '..', '..', 'data', 'crm-app.db'));
...
export const auth = betterAuth({
  ...
  secret: process.env.BETTER_AUTH_SECRET || 'crm-app-dev-secret',
  emailAndPassword: {
    enabled: true,
