...
export const Route = createFileRoute('/bus_company/$id')({
...
function EntityDetailPage() {
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: (savedData) => {
      ...
      if (isNew) {
        navigate({ to: '/bus_company/$id', params: { id: String(savedData['id']) } });
      } else {
