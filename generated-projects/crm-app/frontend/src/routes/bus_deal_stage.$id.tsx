 ...
 *
 * Generated: 2026-05-12T11:57:05.738Z
 * Project: crm-app
 */
...
export const Route = createFileRoute('/bus_deal_stage/$id')({
...
function EntityDetailPage() {
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: (savedData) => {
      ...
      if (isNew) {
        navigate({ to: '/bus_deal_stage/$id', params: { id: String(savedData['id']) } });
      } else {
