 ...
 *
 * Generated: 2026-05-09T16:10:52.366Z
 * Project: my-app
 */
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <p className="text-xl text-muted-foreground font-light max-w-2xl leading-relaxed">
                Manage entities, field layouts, and application configuration for my-app
              </p>
            </div>
            <Button
              variant="outline"
      ...
      <footer className="border-t border-border mt-16">
        <div className="max-w-7xl mx-auto px-8 py-8">
          <p className="text-sm text-muted-foreground">
            my-app · Generated by ERDwithAI · Swiss Clean Design
          </p>
        </div>
      </footer>
    </div>
