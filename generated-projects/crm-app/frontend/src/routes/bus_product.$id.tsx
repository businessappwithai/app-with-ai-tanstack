...
export const Route = createFileRoute('/bus_product/$id')({
...
function EntityDetailPage() {
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: (savedData) => {
      ...
      if (isNew) {
        navigate({ to: '/bus_product/$id', params: { id: String(savedData['id']) } });
      } else {
