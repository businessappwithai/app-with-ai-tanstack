...
export const Route = createFileRoute('/bus_email_template/$id')({
...
function EntityDetailPage() {
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: (savedData) => {
      ...
      if (isNew) {
        navigate({ to: '/bus_email_template/$id', params: { id: String(savedData['id']) } });
      } else {
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['email-template'] });
      navigate({ to: '/bus_email_template' });
    },
    onError: () => {
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <div className="rounded-xl border border-border/60 bg-gradient-to-br from-muted/40 to-muted/20 backdrop-blur-sm p-5 shadow-sm">
              ...
              <div className="flex flex-col gap-2">
                <Link to="/bus_email_template/new">
