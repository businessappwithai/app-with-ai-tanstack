...
test.describe("DealStage CRUD Tests", () => {
  const entityName = "DealStage";
  const entityNamePlural = "bus_deal_stage";
  ...
  test("should display DealStage list", async ({ page }) => {
  ...
  test("should create a new DealStage", async ({ page }) => {
  ...
  test("should view DealStage details", async ({ page }) => {
  ...
  test("should update a DealStage", async ({ page }) => {
  ...
  test("should delete a DealStage", async ({ page }) => {
