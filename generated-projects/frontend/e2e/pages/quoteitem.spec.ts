...
test.describe("QuoteItem CRUD Tests", () => {
  const entityName = "QuoteItem";
  const entityNamePlural = "bus_quote_item";
  ...
  test("should display QuoteItem list", async ({ page }) => {
  ...
  test("should create a new QuoteItem", async ({ page }) => {
  ...
  test("should view QuoteItem details", async ({ page }) => {
  ...
  test("should update a QuoteItem", async ({ page }) => {
  ...
  test("should delete a QuoteItem", async ({ page }) => {
