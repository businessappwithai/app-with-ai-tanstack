...
test.describe("EmailMessage CRUD Tests", () => {
  const entityName = "EmailMessage";
  const entityNamePlural = "bus_email_message";
  ...
  test("should display EmailMessage list", async ({ page }) => {
  ...
  test("should create a new EmailMessage", async ({ page }) => {
  ...
  test("should view EmailMessage details", async ({ page }) => {
  ...
  test("should update a EmailMessage", async ({ page }) => {
  ...
  test("should delete a EmailMessage", async ({ page }) => {
