 ...
 * Pipeline List Page
 *
 * Displays a paginated, sortable list of Pipeline records
...
export const Route = createFileRoute('/bus_pipeline')({
...
function EntityListPage() {
  ...
  const { data: gridFields } = useGridFields('bus_pipeline')
  ...
  const {
    ...
    queryKey: ['pipeline', 'list', page, pageSize, filterParams],
    queryFn: () => {
      ...
      return apiClient.get<PaginatedResponse<Pipeline>>(
        `/api/bus/bus_pipeline?${params.toString()}`,
      )
    },
  })
  ...
  const deleteMutation = useMutation({
    mutationFn: async (id: string) => {
      await apiClient.delete(`/api/bus/bus_pipeline/${id}`)
    },
    onSuccess: () => {
        ...
        <div className="container mx-auto py-8 px-4">
          <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-border/60 bg-muted/30 p-12 text-center backdrop-blur-sm">
            ...
            <p className="text-destructive text-lg font-semibold">
              Error loading Pipeline records
            </p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      <div className="container mx-auto py-8 px-4 space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Pipeline entity</p>
                </div>
              </div>
            </div>
        ...
        <DynamicTable
          ...
          onView={(id) => navigate({ to: '/bus_pipeline/$id', params: { id } })}
          onEdit={(id) => navigate({ to: '/bus_pipeline/$id', params: { id } })}
          onDelete={(id) => {
