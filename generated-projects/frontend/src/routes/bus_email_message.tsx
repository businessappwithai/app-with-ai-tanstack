/**
 * EmailMessage List Page
 *
 * Displays a paginated, sortable list of EmailMessage records
...
export const Route = createFileRoute('/bus_email_message')({
...
function EntityListPage() {
  ...
  const {
    ...
    queryFn: () => {
      ...
      return apiClient.get<PaginatedResponse<EmailMessage>>(
        `/api/bus/bus_email_message?${params.toString()}`,
      )
    },
  })
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      <div className="container mx-auto py-8 px-4 space-y-6">
        ...
        <DynamicTable
          ...
          onView={(id) =>
            navigate({ to: '/bus_email_message/$id', params: { id } })
          }
          onEdit={(id) =>
            navigate({ to: '/bus_email_message/$id', params: { id } })
          }
