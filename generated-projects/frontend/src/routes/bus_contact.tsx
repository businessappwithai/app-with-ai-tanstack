 ...
 * Contact List Page
 *
 * Displays a paginated, sortable list of Contact records
 ...
 *
 * Generated: 2026-05-31T11:58:04.534Z
 * Project: crm-app
 */
...
export const Route = createFileRoute('/bus_contact')({
...
function EntityListPage() {
  ...
  const { data: gridFields } = useGridFields('bus_contact')
  ...
  const {
    ...
    queryKey: ['contact', 'list', page, pageSize, filterParams],
    queryFn: () => {
      ...
      return apiClient.get<PaginatedResponse<Contact>>(
        `/api/bus/bus_contact?${params.toString()}`,
      )
    },
  })
  ...
  const deleteMutation = useMutation({
    mutationFn: async (id: string) => {
      await apiClient.delete(`/api/bus/bus_contact/${id}`)
    },
    onSuccess: () => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      <div className="container mx-auto py-8 px-4 space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Contact entity</p>
                </div>
              </div>
            </div>
        ...
        <DynamicTable
          ...
          onView={(id) => navigate({ to: '/bus_contact/$id', params: { id } })}
          onEdit={(id) => navigate({ to: '/bus_contact/$id', params: { id } })}
          onDelete={(id) => {
