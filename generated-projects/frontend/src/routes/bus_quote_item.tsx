 ...
 * QuoteItem List Page
 *
 * Displays a paginated, sortable list of QuoteItem records
...
export const Route = createFileRoute('/bus_quote_item')({
...
function EntityListPage() {
  ...
  const { data: gridFields } = useGridFields('bus_quote_item')
  ...
  const {
    ...
    queryKey: ['quote-item', 'list', page, pageSize, filterParams],
    queryFn: () => {
      ...
      return apiClient.get<PaginatedResponse<QuoteItem>>(
        `/api/bus/bus_quote_item?${params.toString()}`,
      )
    },
  })
  ...
  const deleteMutation = useMutation({
    mutationFn: async (id: string) => {
      await apiClient.delete(`/api/bus/bus_quote_item/${id}`)
    },
    onSuccess: () => {
        ...
        <div className="container mx-auto py-8 px-4">
          <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-border/60 bg-muted/30 p-12 text-center backdrop-blur-sm">
            ...
            <p className="text-destructive text-lg font-semibold">
              Error loading QuoteItem records
            </p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      <div className="container mx-auto py-8 px-4 space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">QuoteItem entity</p>
                </div>
              </div>
            </div>
        ...
        <DynamicTable
          ...
          onView={(id) =>
            navigate({ to: '/bus_quote_item/$id', params: { id } })
          }
          onEdit={(id) =>
            navigate({ to: '/bus_quote_item/$id', params: { id } })
          }
