 ...
 *
 * Generated: 2026-05-07T09:31:28.777Z
 * Project: crm-app
 */
  ...
  const saveMutation = useMutation({
    mutationFn: async (formData: Partial<Pipeline>) => {
      if (isNew) {
        ...
        return apiClient.patch<Pipeline>(`/api/bus/bus_pipeline/${id}`, formData, {
    ...
    onSuccess: (savedData) => {
      ...
      if (isNew) {
        router.push("/bus_pipeline/" + savedData.id);
      } else {
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    This action cannot be undone. This will permanently delete the Pipeline record.
                  </p>
                </div>
              </div>
