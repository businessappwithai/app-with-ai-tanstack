 ...
 *
 * Generated: 2026-05-07T09:31:28.782Z
 * Project: crm-app
 */
...
export default function TaskListPage() {
  ...
  const {
    ...
    queryFn: () => {
      ...
      return apiClient.get<PaginatedResponse<Task>>(`/api/bus/bus_task?${params.toString()}`);
    },
  });
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      <div className="container mx-auto py-8 px-4 space-y-6">
        ...
        <DynamicTable
          ...
          onView={(id) => router.push(`/bus_task/${id}`)}
          onEdit={(id) => router.push(`/bus_task/${id}`)}
          onDelete={(id) => {
