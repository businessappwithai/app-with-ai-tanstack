 ...
 *
 * Generated: 2026-05-07T09:31:28.794Z
 * Project: crm-app
 */
...
export default function UserListPage() {
  ...
  const {
    ...
    queryFn: () => {
      ...
      return apiClient.get<PaginatedResponse<User>>(`/api/bus/bus_user?${params.toString()}`);
    },
  });
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      <div className="container mx-auto py-8 px-4 space-y-6">
        ...
        <DynamicTable
          ...
          onView={(id) => router.push(`/bus_user/${id}`)}
          onEdit={(id) => router.push(`/bus_user/${id}`)}
          onDelete={(id) => {
