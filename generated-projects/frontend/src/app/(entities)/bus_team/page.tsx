 ...
 *
 * Generated: 2026-05-07T09:31:28.796Z
 * Project: crm-app
 */
...
export default function TeamListPage() {
  ...
  const {
    ...
    queryFn: () => {
      ...
      return apiClient.get<PaginatedResponse<Team>>(`/api/bus/bus_team?${params.toString()}`);
    },
  });
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      <div className="container mx-auto py-8 px-4 space-y-6">
        ...
        <DynamicTable
          ...
          onView={(id) => router.push(`/bus_team/${id}`)}
          onEdit={(id) => router.push(`/bus_team/${id}`)}
          onDelete={(id) => {
