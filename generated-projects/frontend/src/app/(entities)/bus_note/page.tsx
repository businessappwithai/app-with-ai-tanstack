 ...
 *
 * Generated: 2026-05-07T09:31:28.780Z
 * Project: crm-app
 */
...
export default function NoteListPage() {
  ...
  const {
    ...
    queryFn: () => {
      ...
      return apiClient.get<PaginatedResponse<Note>>(`/api/bus/bus_note?${params.toString()}`);
    },
  });
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      <div className="container mx-auto py-8 px-4 space-y-6">
        ...
        <DynamicTable
          ...
          onView={(id) => router.push(`/bus_note/${id}`)}
          onEdit={(id) => router.push(`/bus_note/${id}`)}
          onDelete={(id) => {
