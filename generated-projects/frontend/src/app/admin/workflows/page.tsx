 ...
 *
 * Generated: 2026-05-07T09:31:28.813Z
 * Project: crm-app
 */
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-7xl mx-auto px-8 py-12">
        ...
        <section className="mb-8">
          <div className="mb-6">
            <h2 className="text-sm uppercase tracking-widest text-gray-500 mb-1">Workflow Runs</h2>
            <p className="text-sm text-gray-600">
              View and monitor all workflow executions in the system
            </p>
          </div>
