 ...
 *
 * Generated: 2026-05-07T08:59:26.716Z
 * Project: crm-app
 */
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-7xl mx-auto px-8 py-12">
        ...
        <section className="mb-8">
          <div className="mb-6">
            <h2 className="text-sm uppercase tracking-widest text-gray-500 mb-1">Rules Library</h2>
            <p className="text-sm text-gray-600">
              View and manage all business rules defined in the system
            </p>
          </div>
          ...
          <div className="mb-6 text-sm">
            <span className="font-bold">{filteredRules.length}</span> of {rules?.length || 0} rules
