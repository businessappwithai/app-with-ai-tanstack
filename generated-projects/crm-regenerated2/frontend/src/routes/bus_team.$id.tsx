 ...
 *
 * Generated: 2026-05-16T05:41:34.309Z
...
export const Route = createFileRoute('/bus_team/$id')({
...
function EntityDetailPage() {
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: (savedData) => {
      ...
      if (isNew) {
        navigate({ to: '/bus_team/$id', params: { id: String(savedData['id']) } });
      } else {
