 ...
 *
 * Generated: 2026-05-16T05:41:34.311Z
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <p className="text-xl text-muted-foreground font-light max-w-2xl leading-relaxed">
                Manage entities, field layouts, and application configuration for CRM Regenerated 2
              </p>
            </div>
            <Button
              variant="outline"
      ...
      <main className="max-w-7xl mx-auto px-8 py-12">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-3 gap-0">
            ...
            <Link to="/admin/fields" className="group">
            ...
            {/* Table Browser */}
            <Link to="/admin/tables" className="group">
              <div className="swiss-card p-8 hover:border-primary/50 transition-all">
                <div className="flex items-start justify-between mb-6">
            ...
            {/* Reference Types */}
            <Link to="/admin/references" className="group">
              <div className="swiss-card p-8 hover:border-primary/50 transition-all">
                <div className="flex items-start justify-between mb-6">
      ...
      <footer className="border-t border-border mt-16">
        <div className="max-w-7xl mx-auto px-8 py-8">
          <p className="text-sm text-muted-foreground">
            CRM Regenerated 2 · Generated by ERDwithAI · Swiss Clean Design
          </p>
        </div>
      </footer>
    </div>
