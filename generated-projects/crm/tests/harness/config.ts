...
export const config = {
  ...
  baseUrl: str("E2E_BASE_URL", "http://localhost:4001").replace(/\/+$/, ""),
  ...
  origin: str("E2E_ORIGIN", "http://localhost:4000"),
   ...
   * THROTTLE_LIMIT requests per window (1000/60s in development), which bulk
   * seeding legitimately exceeds.
   */
