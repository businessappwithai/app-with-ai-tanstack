/**
 * Static business rules — Campaign Member
 *
 ...
 *
 * Generated: 2026-08-17T16:41:43.842Z
 * Project: crm
 */
...
const entity = getEntity("CampaignMember");
const suiteId = `e2e-bus_campaign_member-${Date.now().toString(36)}`;

describe("Campaign Member business rules", () => {
