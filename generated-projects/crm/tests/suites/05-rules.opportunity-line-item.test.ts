/**
 * Static business rules — Opportunity Line Item
 *
 ...
 *
 * Generated: 2026-08-17T16:41:43.843Z
 * Project: crm
 */
...
const entity = getEntity("OpportunityLineItem");
const suiteId = `e2e-bus_opportunity_line_item-${Date.now().toString(36)}`;

describe("Opportunity Line Item business rules", () => {
