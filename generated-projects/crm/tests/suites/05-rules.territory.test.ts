/**
 * Static business rules — Territory
 *
 ...
 *
 * Generated: 2026-08-17T17:20:18.839Z
 * Project: crm
 */
...
const entity = getEntity("Territory");
const suiteId = `e2e-bus_territory-${Date.now().toString(36)}`;

describe("Territory business rules", () => {
