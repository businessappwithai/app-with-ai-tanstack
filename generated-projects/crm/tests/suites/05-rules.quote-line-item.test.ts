/**
 * Static business rules — Quote Line Item
 *
 ...
 *
 * Generated: 2026-08-17T17:20:18.843Z
 * Project: crm
 */
...
const entity = getEntity("QuoteLineItem");
const suiteId = `e2e-bus_quote_line_item-${Date.now().toString(36)}`;

describe("Quote Line Item business rules", () => {
