...
// Source: language/browser/fixer.entry.ts
//
// the EML fixer, bundled for the browser. This is the engine the CLI runs, not a
...
//
// Loaded without a bound import, it also answers to globalThis.EMLFixer.
    ...
    stepNodes: {
      ...
      types: [
        ...
        },
        {
          ...
          notes: [
            "`bodyTemplate` interpolates {{key}} from the workflow context."
          ],
  ...
  directives: {
    ...
    reserved: [
      ...
      },
      {
        ...
        status: "validated",
        consumedBy: [
          "language/checker.ts (rule/workflow cross-reference)"
        ],
      ...
      },
      {
        ...
        status: "validated",
        consumedBy: [
          "language/checker.ts (EML230-EML233)"
        ],
