 ...
 *
 * Output goes to `html/assets/appwithai-wasm.js`, which the upload page imports
...
const TARGET = join(ROOT, "html/assets/appwithai-wasm.js");
...
// \`appwithai-wasm generate\` runs; the page imports it so a model generates the
