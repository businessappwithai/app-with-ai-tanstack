/**
 * ORDER_ITEM List Page
 *
 * Displays a paginated, sortable list of ORDER_ITEM records
...
export default function ORDER_ITEMListPage() {
  ...
  const { data: gridFields } = useGridFields("bus_order_item");
  ...
  const {
    ...
    queryKey: ["o-r-d-e-r-i-t-e-m", "list", page, pageSize, filterParams],
    queryFn: () => {
      ...
      return apiClient.get<PaginatedResponse<ORDER_ITEM>>(
        `/api/bus/bus_order_item?${params.toString()}`
      );
    },
  });
  ...
  const deleteMutation = useMutation({
    mutationFn: async (id: string) => {
      await apiClient.delete(`/api/bus/bus_order_item/${id}`);
    },
    onSuccess: () => {
        ...
        <div className="container mx-auto py-8 px-4">
          <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-border/60 bg-muted/30 p-12 text-center backdrop-blur-sm">
            ...
            <p className="text-destructive text-lg font-semibold">
              Error loading ORDER_ITEM records
            </p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      <div className="container mx-auto py-8 px-4 space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">ORDER_ITEM entity</p>
                </div>
              </div>
            </div>
        ...
        <DynamicTable
          ...
          onView={(id) => router.push(`/bus_order_item/${id}`)}
          onEdit={(id) => router.push(`/bus_order_item/${id}`)}
          onDelete={(id) => {
