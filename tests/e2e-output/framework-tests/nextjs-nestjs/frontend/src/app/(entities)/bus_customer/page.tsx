 ...
 * CUSTOMER List Page
 *
 * Displays a paginated, sortable list of CUSTOMER records
 ...
 *
 * Generated: 2026-03-20T16:41:26.613Z
...
export default function CUSTOMERListPage() {
  ...
  const { data: gridFields } = useGridFields("bus_customer");
  ...
  const {
    ...
    queryKey: ["c-u-s-t-o-m-e-r", "list", page, pageSize, filterParams],
    queryFn: () => {
      ...
      return apiClient.get<PaginatedResponse<CUSTOMER>>(
        `/api/bus/bus_customer?${params.toString()}`
      );
    },
  });
  ...
  const deleteMutation = useMutation({
    mutationFn: async (id: string) => {
      await apiClient.delete(`/api/bus/bus_customer/${id}`);
    },
    onSuccess: () => {
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
        <div className="container mx-auto py-8 px-4">
          <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-border/60 bg-muted/30 p-12 text-center backdrop-blur-sm">
            ...
            <p className="text-destructive text-lg font-semibold">Error loading CUSTOMER records</p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      <div className="container mx-auto py-8 px-4 space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">CUSTOMER entity</p>
                </div>
              </div>
            </div>
        ...
        <DynamicTable
          ...
          onView={(id) => router.push(`/bus_customer/${id}`)}
          onEdit={(id) => router.push(`/bus_customer/${id}`)}
          onDelete={(id) => {
