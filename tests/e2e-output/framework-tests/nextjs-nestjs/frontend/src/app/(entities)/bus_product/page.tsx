...
export default function PRODUCTListPage() {
  ...
  const {
    ...
    queryKey: ["p-r-o-d-u-c-t", "list", page, pageSize, filterParams],
    queryFn: () => {
      ...
      return apiClient.get<PaginatedResponse<PRODUCT>>(`/api/bus/bus_product?${params.toString()}`);
    },
  });
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
        <div className="container mx-auto py-8 px-4">
          <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-border/60 bg-muted/30 p-12 text-center backdrop-blur-sm">
            ...
            <p className="text-destructive text-lg font-semibold">Error loading PRODUCT records</p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      <div className="container mx-auto py-8 px-4 space-y-6">
        ...
        <DynamicTable
          ...
          onView={(id) => router.push(`/bus_product/${id}`)}
          onEdit={(id) => router.push(`/bus_product/${id}`)}
          onDelete={(id) => {
