 ...
 * ORDER List Page
 *
 * Displays a paginated, sortable list of ORDER records
...
export default function ORDERListPage() {
  ...
  const { data: gridFields } = useGridFields("bus_order");
  ...
  const {
    ...
    queryKey: ["o-r-d-e-r", "list", page, pageSize, filterParams],
    queryFn: () => {
      ...
      return apiClient.get<PaginatedResponse<ORDER>>(`/api/bus/bus_order?${params.toString()}`);
    },
  });
  ...
  const deleteMutation = useMutation({
    mutationFn: async (id: string) => {
      await apiClient.delete(`/api/bus/bus_order/${id}`);
    },
    onSuccess: () => {
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
        <div className="container mx-auto py-8 px-4">
          <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-border/60 bg-muted/30 p-12 text-center backdrop-blur-sm">
            ...
            <p className="text-destructive text-lg font-semibold">Error loading ORDER records</p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      <div className="container mx-auto py-8 px-4 space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">ORDER entity</p>
                </div>
              </div>
            </div>
        ...
        <DynamicTable
          ...
          onView={(id) => router.push(`/bus_order/${id}`)}
          onEdit={(id) => router.push(`/bus_order/${id}`)}
          onDelete={(id) => {
