 ...
 *
 * Generated: 2026-03-20T16:41:26.599Z
 */
      ...
      useFactory: async (configService: ConfigService) => {
        ...
        if (dbClient === "better-sqlite3") {
          ...
          (knexConfig.connection as any) = {
            filename: configService.get("DATABASE_FILENAME", "./data/nextjs-nestjs-test-app.db"),
          };
          ...
          knexConfig.connection = {
            ...
            database: configService.get("DATABASE_NAME", "nextjs-nestjs-test-app"),
          };
        }
