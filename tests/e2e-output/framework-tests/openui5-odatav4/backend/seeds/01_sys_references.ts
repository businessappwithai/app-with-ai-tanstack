 ...
 *
 * Generated: 2026-02-09T13:00:26.950Z
 */
...
export async function seed(knex: Knex): Promise<void> {
  ...
  await knex("sys_ref_list").del();
  await knex("sys_reference").del();
  ...
  const references = [
    ...
    { sys_reference_id: 11, name: "Integer", description: "Whole number", validation_type: "S" },
    {
      sys_reference_id: 12,
      name: "Amount",
      description: "Decimal number for amounts",
      validation_type: "S",
    },
    {
      sys_reference_id: 13,
    ...
    },
    {
      sys_reference_id: 14,
      name: "Text",
      description: "Long text/memo field",
      validation_type: "S",
    },
    ...
    // Reference Types
    {
      sys_reference_id: 17,
      name: "List",
      description: "Dropdown list from sys_ref_list",
      validation_type: "L",
    },
    {
      sys_reference_id: 18,
    ...
    // Special Types
    {
      sys_reference_id: 21,
      name: "Location",
      description: "Location/address reference",
      validation_type: "T",
    },
    {
      sys_reference_id: 22,
    ...
    // System References
    {
      sys_reference_id: 100,
      name: "Access Level",
      description: "System access level",
      validation_type: "L",
    },
    {
      sys_reference_id: 101,
      name: "Window Type",
      description: "Window type (M/T/Q)",
      validation_type: "L",
    },
    {
      sys_reference_id: 102,
      name: "Event Type",
      description: "Change log event type",
      validation_type: "L",
    },
    {
      sys_reference_id: 103,
      name: "Field Group Type",
      description: "Field group type",
      validation_type: "L",
    },
    {
      sys_reference_id: 104,
      name: "Access Type",
      description: "Table access type",
      validation_type: "L",
    },
  ];

  await knex("sys_reference").insert(
    references.map((ref) => ({
      ...ref,
  ...
  await knex("sys_ref_list").insert(
    refLists.map((ref) => ({
      ...ref,
      entity_type: "D",
      is_active: true,
