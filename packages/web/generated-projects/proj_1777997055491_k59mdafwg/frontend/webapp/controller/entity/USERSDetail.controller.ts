/**
 * USERS Detail Controller - Object Page (Column 3)
 *
 * Dedicated detail controller for Users entity.
 ...
 *
 * Generated: 2026-05-06T11:42:08.777Z
 */
 ...
 */
export default class USERSDetail extends Controller {
  ...
  public onInit(): void {
    ...
    this._getRouter().getRoute("uSERSDetail").attachPatternMatched(this._onRouteMatched.bind(this));
  }
    ...
    try {
      oModel
        ...
        .then(() => {
          oViewModel.setProperty("/busy", false);
          oViewModel.setProperty("/editable", false);
          MessageHelper.showSuccess("Users saved successfully");
        })
        .catch((oError: any) => {
          oViewModel.setProperty("/busy", false);
  ...
  public onDeletePress(): void {
    MessageBox.confirm("Are you sure you want to delete this Users?", {
  ...
  private _deleteRecord(): void {
    ...
    oModel
      ...
      .then(() => {
        oViewModel.setProperty("/busy", false);
        MessageHelper.showSuccess("Users deleted successfully");
        this.onNavBack();
      })
      .catch((oError: any) => {
        oViewModel.setProperty("/busy", false);
