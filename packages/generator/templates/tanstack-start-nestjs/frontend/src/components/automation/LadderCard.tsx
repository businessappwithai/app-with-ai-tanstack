...
const KIND_STYLES: Record<LadderKind, { icon: string; kicker: string; label: string }> = {
  when: {
    icon: "bg-amber-50 dark:bg-amber-950/40 text-amber-700 dark:text-amber-300 border-amber-200 dark:border-amber-800/60",
    kicker: "text-amber-700 dark:text-amber-300",
    label: "When this happens",
  },
  if: {
    icon: "bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400 border-blue-200 dark:border-blue-800/60",
  ...
  loop: {
    icon: "bg-teal-50 dark:bg-teal-950/40 text-teal-700 dark:text-teal-300 border-teal-200 dark:border-teal-800/60",
...
export function LoopFrame({
  ...
  return (
    <div
      className={cn(
        "relative rounded-xl border-l-[3px] bg-teal-50 dark:bg-teal-950/40/30 py-2 pl-4 pr-1",
